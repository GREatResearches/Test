int battery = 3;
bool hasPwSrc = false, image = true, video = false, mobileGuide=true, showDocs=true, text=true;
...
proctype AR04() {
	if
		:: (battery == 2 && hasPwSrc == true) ->  buss!videoOn;buss!imageOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro313 {[] ((battery == 1 && hasPwSrc == false) -> (image == false && video == false))}
