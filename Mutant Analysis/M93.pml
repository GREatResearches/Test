...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false && battery == 3 ) -> buss!imageOff;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR02() {
	if
		:: (battery == 1 && hasPwSrc == true && battery == 3) -> buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR03() {
	if
		:: (battery == 2 && hasPwSrc == false && battery == 3) -> buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR04() {
	if
		:: (battery == 2 && hasPwSrc == true && battery == 3) ->  buss!imageOn;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR05() {
	if
		:: (battery == 3 && battery == 1) -> buss!imageOn;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro21 {<> (battery == 1 && hasPwSrc == false && battery == 3)}
ltl pro22 {<> (battery == 1 && hasPwSrc == true && battery == 3)}
ltl pro23 {<> (battery == 2 && hasPwSrc == false && battery == 3)}
ltl pro24 {<> (battery == 2 && hasPwSrc == true && battery == 3)}
ltl pro25 {<> (battery == 3)}
ltl pro31 {[] ((battery == 1 && hasPwSrc == false && battery == 3) -> <>(battery == 1 && hasPwSrc == false && battery == 3 && image == false && video == false))}
ltl pro32 {[] ((battery == 1 && hasPwSrc == true && battery == 3) -> <>(battery == 1 && hasPwSrc == true && battery == 3 && image == true && video == false))}
ltl pro33 {[] ((battery == 2 && hasPwSrc == false && battery == 3) -> <>(battery == 2 && hasPwSrc == false && battery == 3 && image == true && video == false))}
ltl pro34 {[] ((battery == 2 && hasPwSrc == true && battery == 3) -> <>(battery == 2 && hasPwSrc == true && battery == 3 && image == true && video == true))}
ltl pro35 {[] ((battery == 3 && battery == 1) -> <>(battery == 3 && battery == 1 && image == true && video == true))}
ltl pro41 {<> image}
ltl pro42 {<> video}
ltl pro51 {<> !image}
ltl pro52 {<> !video}
