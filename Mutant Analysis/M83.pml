...
proctype AR01() {
	if
		:: (battery == 2 && hasPwSrc == true) -> buss!imageOff;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro21 {<> (battery == 2 && hasPwSrc == true)}
ltl pro22 {<> (battery == 1 && hasPwSrc == true)}
ltl pro23 {<> (battery == 2 && hasPwSrc == false)}
ltl pro24 {<> (battery == 2 && hasPwSrc == true)}
ltl pro25 {<> (battery == 3)}
ltl pro31 {[] ((battery == 2 && hasPwSrc == true) -> <>(battery == 2 && hasPwSrc == true && image == false && video == false))}
