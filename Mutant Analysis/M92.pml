...
proctype AR01() {
	if
		:: (battery == 4 && hasPwSrc == false) -> buss!imageOff;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR02() {
	if
		:: (battery == 4 && hasPwSrc == true) -> buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR03() {
	if
		:: (battery == 4 && hasPwSrc == false) -> buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR04() {
	if
		:: (battery == 4 && hasPwSrc == true) ->  buss!imageOn;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR05() {
	if
		:: (battery == 4) -> buss!imageOn;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro21 {<> (battery == 4 && hasPwSrc == false)}
ltl pro22 {<> (battery == 4 && hasPwSrc == true)}
ltl pro23 {<> (battery == 4 && hasPwSrc == false)}
ltl pro24 {<> (battery == 4 && hasPwSrc == true)}
ltl pro25 {<> (battery == 4)}
ltl pro31 {[] ((battery == 4 && hasPwSrc == false) -> <>(battery == 1 && hasPwSrc == false && image == false && video == false))}
ltl pro32 {[] ((battery == 4 && hasPwSrc == true) -> <>(battery == 1 && hasPwSrc == true && image == true && video == false))}
ltl pro33 {[] ((battery == 4 && hasPwSrc == false) -> <>(battery == 2 && hasPwSrc == false && image == true && video == false))}
ltl pro34 {[] ((battery == 4 && hasPwSrc == true) -> <>(battery == 2 && hasPwSrc == true && image == true && video == true))}
ltl pro35 {[] ((battery == 4) -> <>(battery == 3 && image == true && video == true))}
ltl pro41 {<> image}
ltl pro42 {<> video}
ltl pro51 {<> !image}
ltl pro52 {<> !video}
