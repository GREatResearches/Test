...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false) -> buss!videoOff;buss!imageOff;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR04() {
	if
		:: (battery == 2 && hasPwSrc == true) ->  buss!imageOn;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro34 {[] ((battery == 2 && hasPwSrc == true) -> <>(battery == 2 && hasPwSrc == true && image == true))}
