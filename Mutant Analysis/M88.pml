...
proctype AR02() {
	if
		:: (battery == 1 && hasPwSrc == true) -> buss!imageOff;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR03() {
	if
		:: (battery == 2 && hasPwSrc == false) -> buss!imageOff;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro32 {[] ((battery == 1 && hasPwSrc == true) -> <>(battery == 1 && hasPwSrc == true && image == false && video == false))}
ltl pro33 {[] ((battery == 2 && hasPwSrc == false) -> <>(battery == 2 && hasPwSrc == false && image == false && video == false))}
