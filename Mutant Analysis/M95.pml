...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false) -> buss!imageOff;buss!videoOff;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR02() {
	if
		:: (battery == 1 && hasPwSrc == true) -> buss!imageOn;buss!videoOff;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR03() {
	if
		:: (battery == 2 && hasPwSrc == false) -> buss!imageOn;buss!videoOff;buss!videoOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR04() {
	if
		:: (battery == 2 && hasPwSrc == true) ->  buss!imageOn;buss!videoOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR05() {
	if
		:: (battery == 3) -> buss!imageOn;buss!videoOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro25 {<> (battery == 3)}
ltl pro31 {[] ((battery == 1 && hasPwSrc == false) -> <>(battery == 1 && hasPwSrc == false && image == false && video == false && video == true))}
ltl pro32 {[] ((battery == 1 && hasPwSrc == true) -> <>(battery == 1 && hasPwSrc == true && image == true && video == false && video == true))}
ltl pro33 {[] ((battery == 2 && hasPwSrc == false) -> <>(battery == 2 && hasPwSrc == false && image == true && video == false && video == true))}
ltl pro34 {[] ((battery == 2 && hasPwSrc == true) -> <>(battery == 2 && hasPwSrc == true && image == true && video == true && video == false))}
ltl pro35 {[] ((battery == 3) -> <>(battery == 3 && image == true && video == true && video == false))}
ltl pro41 {<> image}
ltl pro42 {<> video}
ltl pro51 {<> !image}
ltl pro52 {<> !video}
