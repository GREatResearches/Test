...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false) -> buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR04() {
	if
		:: (battery == 2 && hasPwSrc == true) ->  buss!imageOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro25 {<> (battery == 3)}
ltl pro31 {[] ((battery == 1 && hasPwSrc == false) -> <>(battery == 1 && hasPwSrc == false && image == true && video == false))}
...
ltl pro34 {[] ((battery == 2 && hasPwSrc == true) -> <>(battery == 2 && hasPwSrc == true && image == true && video == false))}
