...
mtype = {imageOn, imageOff, textOn, textOff, videoOn, videoOff,contextChanged,done,adapted}
int numAnswer = 0;
...
proctype AR03() {
	if
		:: (battery == 2 && hasPwSrc == false) -> buss!imageOn;buss!textOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro33 {[] ((battery == 2 && hasPwSrc == false) -> <>(battery == 2 && hasPwSrc == false && image == true && text == false))}
