...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false) -> buss!imageOff;buss!showDocsOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro25 {<> (battery == 3)}
ltl pro31 {[] ((battery == 1 && hasPwSrc == false) -> <>(battery == 1 && hasPwSrc == false && image == false && showDocs == false))}
