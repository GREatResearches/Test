...
proctype AR01() {
	if
		:: (battery == 1 && hasPwSrc == false) -> buss!imageOff;buss!videoOff;buss!imageOn;buss!done
		:: else -> buss!done
	fi
}
...
proctype AR02() {
	if
		:: (battery == 1 && hasPwSrc == true) -> buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro32 {[] ((battery == 1 && hasPwSrc == true) -> <>(battery == 1 && hasPwSrc == true && video == false))}
