...
mtype = {imageOn, imageOff, showDocsOn, showDocsOff, videoOn, videoOff,contextChanged,done,adapted}
int numAnswer = 0;
...
proctype AR03() {
	if
		:: (battery == 2 && hasPwSrc == false) -> buss!showDocsOn;buss!videoOff;buss!done
		:: else -> buss!done
	fi
}
...
ltl pro33 {[] ((battery == 2 && hasPwSrc == false) -> <>(battery == 2 && hasPwSrc == false && showDocs == true && video == false))}
