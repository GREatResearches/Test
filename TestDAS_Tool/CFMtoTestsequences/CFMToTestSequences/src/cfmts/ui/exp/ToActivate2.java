...
public class ToActivate2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ToActivate2 window = new ToActivate2();
	...
	private void initialize() {
		...
		frmToactivate.setTitle("toActivate2");
		frmToactivate.setBounds(100, 100, 265, 300);
