...
do
:: (isBtFull == true && isBtNormal == false && isBtLow == false && hasPwSource == false) -> isBtNormal = true;isBtFull = false;buss!contextChanged;buss?adapted
:: (isBtFull == true && isBtNormal == false && isBtLow == false && hasPwSource == false) -> hasPwSource = true;buss!contextChanged;buss?adapted
:: (isBtNormal == true && isBtFull == false && isBtLow == false && hasPwSource == false) -> isBtLow = true;isBtNormal = false;buss!contextChanged;buss?adapted
:: (isBtNormal == true && isBtFull == false && isBtLow == false && hasPwSource == false) -> hasPwSource = true;buss!contextChanged;buss?adapted
:: (isBtLow == true && isBtFull == false && isBtNormal == false && hasPwSource == false) -> hasPwSource = true;buss!contextChanged;buss?adapted
:: (isBtFull == true && hasPwSource == true && isBtNormal == false && isBtLow == false) -> hasPwSource = false;buss!contextChanged;buss?adapted
:: (isBtNormal == true && hasPwSource == true && isBtFull == false && isBtLow == false) -> hasPwSource = false;buss!contextChanged;buss?adapted
:: (isBtNormal == true && hasPwSource == true && isBtFull == false && isBtLow == false) -> isBtFull = true;isBtNormal = false;buss!contextChanged;buss?adapted
:: (isBtLow == true && hasPwSource == true && isBtFull == false && isBtNormal == false) -> hasPwSource = false;buss!contextChanged;buss?adapted
:: (isBtLow == true && hasPwSource == true && isBtFull == false && isBtNormal == false) -> isBtNormal = true;isBtLow = false;buss!contextChanged;buss?adapted
od
}
